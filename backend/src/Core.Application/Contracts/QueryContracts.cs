...
public sealed record QueryRequest(string Question, string UserId, string Role, string? CorrelationId = null, string? SessionId = null, DatabaseConfig? Connection = null);
